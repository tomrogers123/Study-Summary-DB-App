	...
	<div id="main-wrap">
		...
		<form method="post" action="login.php">
			...
			<div>
				...
				<input type="text" id="username" id="username" value="<?php echo $_COOKIE['CStudies_usr'] ?>">
			</div>

			<div>
				<label for="password">Password:</label>
				<input type="text" id="username" id="username" value="<?php echo $_COOKIE['CStudies_pass'] ?>">
			</div>
